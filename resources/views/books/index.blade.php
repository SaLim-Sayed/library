...
<div class="card bg-success m-2 p-2">
    <div class="row">
        <div class="col">
            <input type="text" class="  form-control" placeholder="Search for a Book" style="width: 20rem;"
                id="keyword">
        </div>
        <div class="col">
            <a class="  btn btn-primary mb-2" style="width: 20rem;" href="{{ route('books.create') }}">Creete New
                Book</a>
        </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <div class="card">
                ...
                <a href="{{ route('notes.create') }} " style="width: 25rem;" class=" container btn btn-info">Add new
                    note</a>
            </div>
            @endauth

            @auth
            {{-- <a class=" container btn btn-primary mb-2" style="width: 20rem;" href="{{ route('books.create') }}">Creete
            New
            Book</a> --}}
            @endauth
        </div>
